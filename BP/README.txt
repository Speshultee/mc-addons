...
3.  If you don't already have "Better Command Detection", download it here:
  • https://mcpedl.com/betther-command-detection/

4.  However, the latest update is not always immediately published to MCPEDL so join their Discord:
  • https://discord.com/invite/cPvgNdvEuh
